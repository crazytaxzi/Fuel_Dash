(() => {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      @media(max-width:760px){.today-heading,.today-toolbar{align-items:stretch;flex-direction:column}.today-heading-actions{flex-wrap:wrap}.today-search{width:auto}.today-attention-banner{grid-template-columns:38px 1fr}.today-attention-banner .button{grid-column:1/-1}.worked-card{grid-template-columns:1fr}.today-card-state{justify-content:flex-start}.today-card-actions{justify-content:stretch}.today-card-actions button{flex:1}}
    `;
