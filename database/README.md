...
- `dashboard-db.js` uses IndexedDB as the source of truth for dashboard settings, manual PTA data, driver notes, PTA notes, transition selections, and worked-note completion state.
